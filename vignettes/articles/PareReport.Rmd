---
title: "PaRe Report: TreatmentPatterns [2.7.0]"
...
output:
  html_document:
    ...
    theme: cosmo
vignette: >
  %\VignetteIndexEntry{TreatmentPatterns [2.7.0]}
...
tryCatch({
  DT::datatable(PaRe::checkDependencies(repo = repo, dependencyType = "Imports"))
}, error = function(e) {
